...
function Main_main() {
	...
	let this3;
	if(d1 == null) {
		this3 = DynamicValue.createNone();
	} else {
		this3 = d1;
	}
	let resultThree = this3.getValue();
	...
	haxe_Log.trace(speedNormal,{ fileName : "src/Main.hx", lineNumber : 14, className : "_Main.Main_Fields_", methodName : "main", customParams : ["Speed normal from Constants" + result]});
